...
<section>
    ...
    <div class="uk-grid uk-grid-medium" data-uk-grid-margin data-uk-grid-match="{target:'.md-card'}">
        ...
        <div id="banner" class="uk-width-medium-1-3 text">
	...
	C83.397,112.083,79.231,113.153,65.638,112.37z"/>
        ...
        <div id="banner+link" class="uk-width-medium-1-3 text">
        ...
        <div id="mailingList" class="uk-width-medium-1-3 text">
        ...
        <div id="captcha" class="uk-width-medium-1-3 text">
        ...
        <div id="encuesta" class="uk-width-medium-1-3 text">
        ...
        <div id="video" class="uk-width-medium-1-3 text">
        ...
        <div class="note">
            <span>Costo por cada interaccion </span>
        </div>
</section>